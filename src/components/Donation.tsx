  ...
  return (
    <div class="mt-2">
      <div onClick={() => { setShow(show() ? 0 : 1) }}>
        ...
        <p mt-1 text-xs op-60>感谢 <span gpt-subtitle text-xs>匿名x14</span>,M,姜*凡,E*s,二*三,SK**小明,Li**He,我被**包围了,你你你,雷,太阳保安,达不溜,Fe*ix,我叫孔子,neko**6z,巉巉,【那一段回忆、*】,缥缈,我在故我思,贰拾叁かい,zzzzy,Axis,腥白吆,C-c.减少期待,192.168.0.1,SD,星月弥天,Eurek4,哈哈,夏之星,chopsticks0253,I'm fine!,菲小羊,云,乏味,玖玖Rae,学习,MYBEA***ASY,吕刑褶,菲小羊,rumia,头绿心黄大菠萝OvO,Yuang,一人一,暖暖,Su_XH,菲小羊 的捐赠 <span gpt-subtitle text-xs>感谢B站UP主:叫憨子吧,木木子灵的推荐</span></p>
