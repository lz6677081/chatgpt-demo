  ...
  return (
    <div class="mt-2">
      <div onClick={() => { setShow(show() ? 0 : 1) }}>
        ...
        <p mt-1 text-xs op-60>感谢 匿名,匿名,M,姜*凡,E*s,二*三,SK**小明,匿名,Li**He,匿名,我被**包围了,匿名,你你你,雷,太阳保安,达不溜,Fe*ix,我叫孔子,neko**6z,巉巉,【那一段回忆、*】,匿名,缥缈,我在故我思,贰拾叁かい,zzzzy,匿名,Axis,腥白吆,C-c.匿名,减少期待 的捐赠</p>
