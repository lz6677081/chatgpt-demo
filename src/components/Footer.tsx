  ...
  return (
    <footer>
      <div mt-6 text-xs>
        ...
        {/* <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://claude.chatxyz.online" rel="noreferrer">赞助商: 据说比GPT4更聪明的claude3(已支持claude-3-opus)点击进入</a>😎</div> */}
      </div>
      <div mt-6 text-xs>
