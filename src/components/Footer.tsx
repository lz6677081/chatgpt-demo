  ...
  return (
    <footer>
      <div mt-6 text-xs>
        ...
        <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://chat11.chatgg.world" rel="noreferrer">赞助商: 不够聪明?付费使用GPT4(已支持gpt-4o)点击进入</a>😎</div>
        <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://claude.chatgg.world" rel="noreferrer">赞助商: 体验claude3(已支持claude-3-opus)点击进入</a>😎</div>
        <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://mini4.chatgg.world" rel="noreferrer">赞助商: 比3.5更聪明,每问低至0.02元(最新gpt-4o-mini)点击进入</a>😎</div>
      </div>
      <div mt-6 text-xs>
