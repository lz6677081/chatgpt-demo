  ...
  return (
    <footer>
      <div mt-6 text-xs>
        ...
        <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://chat11.aichats.site" rel="noreferrer">赞助商: 免费体验GPT4(已支持gpt-4-turbo-2024-04-09)点击进入</a>😎</div>
        <div mt-2><a target="_blank" class=" gpt-subtitle text-xs" href="https://claude.aichats.site" rel="noreferrer">赞助商: 免费体验claude3(已支持claude-3-opus)点击进入</a>😎</div>
      </div>
      <div mt-6 text-xs>
